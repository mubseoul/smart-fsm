    ...
    function defaultTemplate($id)
    {
        $templateData = [
            ...
            'client_create' => [
                ...
                'name' => 'New Client',
                'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}'],
                'subject' => 'Welcome to {company_name}!',
                'templete' => '
                    <p><strong>Dear {client_name},</strong></p><p>Welcome to {company_name}!</p><p>We are delighted to have you with us. Our goal is to provide you with the best service possible, and we hope to exceed your expectations.</p><p>If you have any questions, feel free to reach out to us via email at <a href="mailto:{company_email}">{company_email}</a> or call us at {company_phone_number}. You can also visit us at our address: {company_address}.</p><p>We appreciate your trust. Thank you for choosing {company_name}!</p><p>Best regards,</p><p>The {company_name} Team</p>
                ',
            ],
            'wo_request_create' => [
                'module' => 'wo_request_create',
                'name' => 'New WO Request',
                'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}', '{user_name}', '{user_email}', '{user_phone_number}', '{asset}', '{due_date}', '{priority}', '{status}', '{preferred_date}', '{preferred_time}', '{request_detail}'],
                'subject' => 'New Work Order Request: {asset}',
                'templete' => '
                    <p><strong>Dear {client_name},</strong></p><p>We have received your work order request at {company_name}.</p><p><strong>Request Details:</strong></p><ul><li><strong>Asset:</strong> {asset}</li><li><strong>Priority:</strong> {priority}</li><li><strong>Status:</strong> {status}</li><li><strong>Due Date:</strong> {due_date}</li><li><strong>Preferred Date:</strong> {preferred_date}</li><li><strong>Preferred Time:</strong> {preferred_time}</li><li><strong>Request Details:</strong> {request_detail}</li></ul><p><strong>Assign Details:</strong></p><ul><li><strong>User Name:</strong> {user_name}</li><li><strong>Email:</strong> <a href="mailto:{user_email}">{user_email}</a></li><li><strong>Phone Number:</strong> {user_phone_number}</li></ul><p>If you have any questions or require further assistance, feel free to reach out to us via email at <a href="mailto:{company_email}">{company_email}</a> or call us at {company_phone_number}.</p><p>Thank you for choosing {company_name}!</p><p>Best regards,</p><p>The {company_name} Team</p>
                ',
            ],
            'wo_request_assign' => [
                'module' => 'wo_request_assign',
                'name' => 'WO Request Assign',
                'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{client_name}', '{client_email}', '{client_phone_number}', '{asset}', '{due_date}', '{priority}', '{status}', '{preferred_date}', '{preferred_time}', '{request_detail}'],
                'subject' => 'Work Order Request Assigned: {asset}',
                'templete' => '
                    <p><strong>Dear {user_name},</strong></p><p>You have been assigned a new work order request at {company_name}.</p><p><strong>Request Details:</strong></p><ul><li><strong>Asset:</strong> {asset}</li><li><strong>Priority:</strong> {priority}</li><li><strong>Status:</strong> {status}</li><li><strong>Due Date:</strong> {due_date}</li><li><strong>Preferred Date:</strong> {preferred_date}</li><li><strong>Preferred Time:</strong> {preferred_time}</li><li><strong>Request Details:</strong> {request_detail}</li></ul><p><strong>Client Details:</strong></p><ul><li><strong>Client Name:</strong> {client_name}</li><li><strong>Email:</strong> <a href="mailto:{client_email}">{client_email}</a></li><li><strong>Phone Number:</strong> {client_phone_number}</li></ul><p>If you have any questions or need further clarification, feel free to contact us via email at <a href="mailto:{company_email}">{company_email}</a> or call us at {company_phone_number}.</p><p>Thank you,</p><p>The {company_name} Team</p>
                ',
            ],
            'estimate_create' => [
                'module' => 'estimate_create',
                'name' => 'New Estimate',
                'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}', '{estimate_number}', '{estimate_title}', '{asset}', '{due_date}', '{status}', '{services_details}', '{parts_details}'],
                'subject' => 'New Estimate: {estimate_number}',
                'templete' => '
                    <p><strong>Dear {client_name},</strong></p><p>We are pleased to present you with a new estimate from {company_name}.</p><p><strong>Estimate Details:</strong></p><ul><li><strong>Estimate Number:</strong> {estimate_number}</li><li><strong>Estimate Title:</strong> {estimate_title}</li><li><strong>Asset:</strong> {asset}</li><li><strong>Due Date:</strong> {due_date}</li><li><strong>Status:</strong> {status}</li><li>&nbsp;</li></ul><p><strong>Services Details:</strong></p><p>{services_details}</p><p><strong>Parts Details:</strong></p><p>{parts_details}</p><p>&nbsp;</p><p>If you have any questions or need further information, feel free to contact us at <a href="mailto:{company_email}">{company_email}</a> or call us at {company_phone_number}.</p><p>Thank you for choosing {company_name}!</p><p>Best regards,</p><p>The {company_name} Team</p>
                ',
            ],
            'work_order_create' => [
                'module' => 'work_order_create',
                'name' => 'New Work Order',
                'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}', '{work_order_number}', '{user_name}', '{user_email}', '{user_phone_number}', '{type }', '{asset}', '{status}', '{due_date}', '{priority}', '{status}', '{preferred_date}', '{preferred_time}', '{work_order_detail}', '{services_details}', '{parts_details}'],
                'subject' => 'New Work Order: {work_order_number}',
                'templete' => '
                    <p><strong>Dear {client_name},</strong></p><p>We are pleased to inform you that a new work order has been created at {company_name}.</p><p><strong>Work Order Details:</strong></p><ul><li><strong>Work Order Number:</strong> {work_order_number}</li><li><strong>Type:</strong> {type}</li><li><strong>Asset:</strong> {asset}</li><li><strong>Status:</strong> {status}</li><li><strong>Priority:</strong> {priority}</li><li><strong>Due Date:</strong> {due_date}</li><li><strong>Preferred Date:</strong> {preferred_date}</li><li><strong>Preferred Time:</strong> {preferred_time}</li></ul><p><strong>Work Order Detail:</strong> {work_order_detail}</p><p><strong>Services Details:</strong></p><p>{services_details}</p><p><strong>Parts Details:</strong></p><p>{parts_details}</p><p>If you have any questions or require further assistance, please do not hesitate to contact us at <a href="mailto:{company_email}">{company_email}</a> or call us at {company_phone_number}.</p><p>Thank you for choosing {company_name}!</p><p>Best regards,</p><p>The {company_name} Team</p>
                ',
            ],
            'work_order_assign' => [
                'module' => 'work_order_assign',
                'name' => 'Work Order Assign',
                'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{work_order_number}', '{client_name}', '{client_email}', '{client_phone_number}', '{type }', '{asset}', '{status}', '{due_date}', '{priority}', '{status}', '{preferred_date}', '{preferred_time}', '{work_order_detail}', '{services_details}', '{parts_details}'],
                'subject' => 'Work Order Assigned: {work_order_number}',
                'templete' => '
                    <p><strong>Dear {user_name},</strong></p><p>You have been assigned a new work order at {company_name}.</p><p><strong>Work Order Details:</strong></p><ul><li><strong>Work Order Number:</strong> {work_order_number}</li><li><strong>Type:</strong> {type}</li><li><strong>Asset:</strong> {asset}</li><li><strong>Status:</strong> {status}</li><li><strong>Priority:</strong> {priority}</li><li><strong>Due Date:</strong> {due_date}</li><li><strong>Preferred Date:</strong> {preferred_date}</li><li><strong>Preferred Time:</strong> {preferred_time}</li></ul><p><strong>Work Order Detail:</strong> {work_order_detail}</p><p><strong>Services Details:</strong></p><p>{services_details}</p><p><strong>Parts Details:</strong></p><p>{parts_details}</p><p><strong>Client Details:</strong></p><ul><li><strong>Client Name:</strong> {client_name}</li><li><strong>Email:</strong> <a href="mailto:{client_email}">{client_email}</a></li><li><strong>Phone Number:</strong> {client_phone_number}</li></ul><p>If you have any questions or need further clarification, feel free to contact us at <a href="mailto:{company_email}">{company_email}</a> or call us at {company_phone_number}.</p><p>Thank you,</p><p>The {company_name} Team</p>
                ',
            ],
            'invoice_create' => [
                'module' => 'invoice_create',
                'name' => 'New Invoice',
                'short_code' => ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}', '{invoice_date}', '{due_date}', '{invoice_number}', '{work_order_number}', '{total_amount}', '{discount_amount}', '{status}'],
                'subject' => 'New Invoice from {company_name} - Invoice Number: {invoice_number}',
                'templete' => '
                    <p><strong>Dear {client_name},</strong></p><p>We are pleased to present your new invoice from {company_name}.</p><p><strong>Invoice Details:</strong></p><ul><li><strong>Invoice Number:</strong> {invoice_number}</li><li><strong>Invoice Date:</strong> {invoice_date}</li><li><strong>Due Date:</strong> {due_date}</li><li><strong>Work Order Number:</strong> {work_order_number}</li><li><strong>Total Amount:</strong> {company_currency} {total_amount}</li><li><strong>Discount Amount:</strong> {company_currency} {discount_amount}</li><li><strong>Status:</strong> {status}</li></ul><p>If you have any questions or require further assistance, please do not hesitate to contact us at <a href="mailto:{company_email}">{company_email}</a> or call us at {company_phone_number}.</p><p>Thank you for choosing {company_name}!</p><p>Best regards,</p><p>The {company_name} Team</p>
                ',
            ],
        ];
    ...
    function MessageReplace($notification, $id = 0)
    {
        ...
        if (!empty($notification)) {
            ...
            if ($notification->module == 'client_create') {
                $user = User::find($id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $user->name, env('APP_URL'), $user->email, $notification['password']];
            }
            if ($notification->module == 'wo_request_create') {
                $request = WORequest::find($id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}', '{user_name}', '{user_email}', '{user_phone_number}', '{asset}', '{due_date}', '{priority}', '{status}', '{preferred_date}', '{preferred_time}', '{request_detail}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $request->clients->name, $request->assigned->name, $request->assigned->email, $request->assigned->phone_number, $request->assets->name, dateFormat($request->due_date), $request->priority, $request->status, dateFormat($request->preferred_date), timeFormat($request->preferred_time), $request->request_detail];
            }
            if ($notification->module == 'wo_request_assign') {
                $request = WORequest::find($id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{client_name}', '{client_email}', '{client_phone_number}', '{asset}', '{due_date}', '{priority}', '{status}', '{preferred_date}', '{preferred_time}', '{request_detail}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $request->assigned->name, $request->clients->name, $request->clients->email, $request->clients->phone_number, $request->assets->name, dateFormat($request->due_date), $request->priority, $request->status, dateFormat($request->preferred_date), timeFormat($request->preferred_time), $request->request_detail];
            }
            if ($notification->module == 'estimate_create') {
                $estimation = Estimation::find($id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}', '{estimate_number}', '{estimate_title}', '{asset}', '{due_date}', '{status}', '{services_details}', '{parts_details}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $estimation->clients->name, estimationPrefix() . $estimation->estimation_id, $estimation->title, $estimation->assets->name, $estimation->due_date, $estimation->status, $notification->serviceDetail, $notification->partsDetail];
            }
            if ($notification->module == 'work_order_create') {
                $workOrder = WorkOrder::find($id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}', '{work_order_number}', '{user_name}', '{user_email}', '{user_phone_number}', '{type}', '{asset}', '{due_date}', '{priority}', '{status}', '{preferred_date}', '{preferred_time}', '{work_order_detail}', '{services_details}', '{parts_details}'];
                $replace = $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $workOrder->clients->name, workOrderPrefix() . $workOrder->wo_id, $workOrder->assigned->name, $workOrder->assigned->email, $workOrder->assigned->phone_number, $workOrder->types->type, $workOrder->assets->name, dateFormat($workOrder->due_date), $workOrder->priority, $workOrder->status, dateFormat($workOrder->preferred_date), timeFormat($workOrder->preferred_time), $workOrder->preferred_note, $notification->serviceDetail, $notification->partsDetail];
            }
            if ($notification->module == 'work_order_assign') {
                $workOrder = WorkOrder::find($id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{user_name}', '{work_order_number}', '{client_name}', '{client_email}', '{client_phone_number}', '{type }', '{asset}', '{due_date}', '{priority}', '{status}', '{preferred_date}', '{preferred_time}', '{work_order_detail}', '{services_details}', '{parts_details}'];
                $replace = $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $workOrder->assigned->name, workOrderPrefix() . $workOrder->wo_id, $workOrder->clients->name, $workOrder->clients->email, $workOrder->clients->phone_number, $workOrder->types->type, $workOrder->assets->name, dateFormat($workOrder->due_date), $workOrder->priority, $workOrder->status, dateFormat($workOrder->preferred_date), timeFormat($workOrder->preferred_time), $workOrder->preferred_note, $notification->serviceDetail, $notification->partsDetail];
            }
            if ($notification->module == 'invoice_create') {
                $invoice = Invoice::find($id);
                $search = ['{company_name}', '{company_email}', '{company_phone_number}', '{company_address}', '{company_currency}', '{client_name}', '{invoice_date}', '{due_date}', '{invoice_number}', '{work_order_number}', '{total_amount}', '{discount_amount}', '{status}'];
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $invoice->clients->email, dateFormat($invoice->invoice_date), dateFormat($invoice->due_date), invoicePrefix() . $invoice->invoice_id, workOrderPrefix() . $invoice->workorders->wo_id, $invoice->total, $invoice->discount, $invoice->status];
            }
    ...
    function HomePageSection()
    {
        $retuen = [
            ...
            [
                'title' => 'Banner',
                'section' => 'Section 1',
                'content_value' => '{"name":"Banner","section_enabled":"active","title":"Smart FSM - Field Service Management System","sub_title":"FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.","btn_name":"Get Started","btn_link":"#","section_footer_text":"Manage your business efficiently with our all-in-one solution designed for performance, security, and scalability.","section_footer_image":{},"section_main_image":{},"section_footer_image_path":"upload\/homepage\/banner_2.png","section_main_image_path":"upload\/homepage\/banner_1.png","box_image_1_path":"","box_image_2_path":"","box_image_3_path":"","Box1_image_path":"","Box2_image_path":"","Sec4_box1_image_path":"","Sec4_box2_image_path":"","Sec4_box3_image_path":"","Sec4_box4_image_path":"","Sec4_box5_image_path":"","Sec4_box6_image_path":"","Sec7_box1_image_path":"","Sec7_box2_image_path":"","Sec7_box3_image_path":"","Sec7_box4_image_path":"","Sec7_box5_image_path":"","Sec7_box6_image_path":"","Sec7_box7_image_path":"","Sec7_box8_image_path":""}',
                'content' => '
                <header id="home">
                    <div class="container">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-5 col-xl-4">
                                <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <span class="text-primary">Smart FSM - Field Service Management System</span>
                                </h1>
                                <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                                    FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.
                                </h4>
                        ...
                        <div class="container">
                            <div class="row align-items-center g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-lg w-75 my-3 my-md-4">Smart FSM has made it easy for developers of any skill level to
                                        use their product.</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center title">
                            <div class="col-md-9 col-lg-6 text-center">
                                <h2 class="h1">What does Smart FSM offer?</h2>
                                <p class="text-lg">
                                    Smart FSM is a reliable choice for your admin panel needs, offering a wide range of features to
                        ...
                        <div class="row g-4 text-center">
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>
                                    Smart FSM can improve the user experience of your web application by providing a clear and intuitive
                            ...
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>
                                    Smart FSM can save developers time and effort by providing a pre-built user interface, allowing them
                            ...
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>Smart FSM simplifies admin panel development with easy theme setup and clear code with flexible
                                    layouts options.</p>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>
                                    Smart FSM uses scalable technologies and resources to ensure that your admin panel remains efficient
                            ...
                            <div class="col-md-6 col-xl-4">
                                ...
                                <p>
                                    ...
                                    and effectively use the Smart FSM.
                                </p>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <img src="assets/images/landing/img-design-6.svg" alt="img" class="img-fluid" />
                                <h3 class="my-4 fw-semibold">Performance Centric</h3>
                                <p>Smart FSM is a performance-centric dashboard template that is designed to deliver optimal performance
                    ...
                    <div class="container">
                        <div class="row justify-content-center title">
                            <div class="col-md-9 col-lg-6 text-center">
                                ...
                                <p class="text-lg">Smart FSM has conceptul working apps like Chat, Inbox, E-commerce, Invoice,
            ...
            [
                'title' => 'Core Features',
                'section' => 'Section 6',
                'content_value' => '{"name":"Core Features","section_enabled":"active","Sec6_title":"Core Features","Sec6_info":"Core Modules For Your Business","Sec6_Box_title":["Dashboard","Workorder","Workorder Detail","Services & Parts","Invoice"],"Sec6_Box_subtitle":["FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.","FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.","FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.","FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.","FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.","Complete Message App with all possible option"],"Sec6_box_image":[{},{},{},{},{},{}],"section_footer_image_path":"","section_main_image_path":"","box_image_1_path":"","box_image_2_path":"","box_image_3_path":"","Box1_image_path":"","Box2_image_path":"","Sec4_box1_image_path":"","Sec4_box2_image_path":"","Sec4_box3_image_path":"","Sec4_box4_image_path":"","Sec4_box5_image_path":"","Sec4_box6_image_path":"","Sec6_box0_image_path":"upload\/homepage\/1.png","Sec6_box1_image_path":"upload\/homepage\/2.png","Sec6_box2_image_path":"upload\/homepage\/3.png","Sec6_box3_image_path":"upload\/homepage\/4.png","Sec6_box4_image_path":"upload\/homepage\/5.png","Sec6_box5_image_path":"upload\/homepage\/6.png","Sec6_box6_image_path":"","Sec7_box1_image_path":"","Sec7_box2_image_path":"","Sec7_box3_image_path":"","Sec7_box4_image_path":"","Sec7_box5_image_path":"","Sec7_box6_image_path":"","Sec7_box7_image_path":"","Sec7_box8_image_path":""}',
                'content' => '
                    ...
                    <div class="container">
                        <div class="row justify-content-center title">
                            <div class="col-md-9 col-lg-6 text-center">
                                ...
                                <p class="text-lg">Smart FSM has conceptul working apps like Chat, Inbox, E-commerce, Invoice, Kanban,
                                    and Calendar</p>
                            </div>
                        </div>
                        <div class="row text-center justify-content-center">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-9">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <h2 class="mb-0 text-white">Choose Smart FSM for</h2>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                            ...
                            <div class="col-12">
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        ...
                                        <b>Is Smart FSM Support Typescript?</b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
                                        data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                        Yes, Smart FSM Support the TypeScript and it is only available in Plus and Extended License.
                                        </div>
                                    </div>
                                    </div>
                                    <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingfour">
                                        ...
                                        <b>Is there any Road map for Smart FSM?</b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapse-four" class="accordion-collapse collapse" aria-labelledby="flush-headingfour"
                                        data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                        Smart FSM is our flagship React Dashboard Template and we always add the new features for the long
                                        run. You can check
            ...
            [
                ...
                'section' => 'Section 10',
                'content_value' => '{"name":"AboutUS - Footer","section_enabled":"active","Sec10_title":"About Smart FSM","Sec10_info":"FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.","section_footer_image_path":"","section_main_image_path":"","box_image_1_path":"","box_image_2_path":"","box_image_3_path":"","Box1_image_path":"","Box2_image_path":"","Sec4_box1_image_path":"","Sec4_box2_image_path":"","Sec4_box3_image_path":"","Sec4_box4_image_path":"","Sec4_box5_image_path":"","Sec4_box6_image_path":"","Sec7_box1_image_path":"","Sec7_box2_image_path":"","Sec7_box3_image_path":"","Sec7_box4_image_path":"","Sec7_box5_image_path":"","Sec7_box6_image_path":"","Sec7_box7_image_path":"","Sec7_box8_image_path":""}',
                'content' => '
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <h4 class="my-3 text-white">About Smart FSM</h4>
                                <p class="mb-4 text-white text-opacity-75">
                                    Smart FSM React is a dashboard template that utilizes the Material-UI framework and the React
                            ...
                            <div class="col-md-8">
                                <div class="row g-4">
                                    ...
                                    <div class="col-6 col-md-3 wow fadeInUp" data-wow-delay="0.6s">
                                        <h5 class="mb-3 mb-sm-4 text-white">Smart FSM Eco-System</h5>
                                        <ul class="list-unstyled footer-link">
