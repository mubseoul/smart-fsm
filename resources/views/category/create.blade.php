    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <div class="form-check form-switch custom-switch-v1 mb-2">
                <input type="checkbox" class="form-check-input input-secondary" name="active" id="active" checked>
                {{Form::label('active',__('Active'),array('class'=>'form-label'))}}
            </div>
        </div>
        <div class="form-group col-md-6">
            <div class="form-check form-switch custom-switch-v1 mb-2">
                <input type="checkbox" class="form-check-input input-secondary" name="is_deletable" id="is_deletable" checked>
