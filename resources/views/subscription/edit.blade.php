...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <div class="form-check form-switch custom-switch-v1 mb-2">
                <input type="checkbox" class="form-check-input input-secondary" name="trial_enabled" id="trial_enabled" {{$subscription->trial_enabled==1?'checked':''}}>
        ...
        <div class="form-group col-md-6">
            ...
            {{Form::number('trial_days',null,array('class'=>'form-control','placeholder'=>__('Enter trial days'),'min'=>'1','max'=>'365'))}}
